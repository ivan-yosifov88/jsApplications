...
import { getAllMemes, getUserMemes } from "../api/data.js";
import { html } from "../library.js";

const myProfileViewTemplate = (memes ,memeTemplate) => html`
...
export async function myProfilePage(context) {
    const memes = await getUserMemes(userData._ownerId)
    context.render(myProfileViewTemplate(memes, memeTemplate))
}